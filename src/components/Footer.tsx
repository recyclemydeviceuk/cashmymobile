      ...
      <div className="bg-gray-900 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-6 sm:py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
          <div>
            ...
            <p className="text-gray-400 text-xs sm:text-sm mt-1">Get a free instant quote — no obligation, fast bank transfer.</p>
          </div>
          ...
          <ul className="space-y-3 sm:space-y-4">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:Support@cashmymobile.co.uk" className="text-xs sm:text-sm text-gray-400 hover:text-red-400 transition-colors break-all">
                  Support@cashmymobile.co.uk
                </a>
              </div>
            </li>
            <li className="flex items-start gap-3">
